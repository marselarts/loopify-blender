...
class LPF_OT_ShiftFcurveValuesOp(bpy.types.Operator):
    """Offset selected animated objects or bones fcurves values. 
Bones option works only with one armature object with selected bones"""
    bl_idname = "loopify.shift_fcurve_values"
    bl_label = "Shift Fcurves Y"
    ...
    def execute(self, context):
        ...
        instances.offset_value(offset,global_offset,reset_curves)
